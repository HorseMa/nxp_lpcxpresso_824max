...
int main( void )
{
    ...
    #error "Please define a region in the compiler options."
                ...
                xTimerChangePeriod( &Led1Timer, 25 );

                xTimerCreate( &Led2Timer, OnLed2TimerEvent );
                xTimerChangePeriod( &Led2Timer, 25 );

                xTimerCreate( &Led4Timer, OnLed4TimerEvent );
                xTimerChangePeriod( &Led4Timer, 25 );
